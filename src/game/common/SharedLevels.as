package game.common 
{
	...
	public class SharedLevels implements ILevel
	{
		...
		{ "humanName":"Rita", "Health":50, "newX":50, "newY":400, "newAngle":0, 
			...
			"poolTargets":[ { "targetType":SharedConst.TYPE_WAYPOINT, "targetName":"waypoint", "targetAction":SharedConst.ACTION_GOTO, "tPoint":new EmptyWorldObject("waypoint", new Point(700, 350)), "isCycling":true }, { "targetType":SharedConst.TYPE_WAITING, "targetName":"waypoint3", "targetAction":"1", "tPoint":new EmptyWorldObject("waypoint2", new Point(0, 0)), "isCycling":true }, { "targetType":SharedConst.TYPE_WAYPOINT, "targetName":"waypoint2", "targetAction":SharedConst.ACTION_GOTO, "tPoint":new EmptyWorldObject("waypoint2", new Point(400, 100)), "isCycling":true } ],
